...
export const FlightSchema = z.object({
    ...
    arrivalTime: z.coerce.string({message: "The arrival date must be string."}).date("The arrival date must be of an iso format: YYYY-MM_DDTHH:m::ssZ."),
    departureTime: z.coerce.string({message: "The departure date must be string."}).date("The departure date must be of an iso format: YYYY-MM_DDTHH:m::ssZ."),
