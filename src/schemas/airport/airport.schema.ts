...
export const AirportSchema = z.object({
    ...
    code: z.string({message: "The airport code must be string."}).length(3, "The airport code must consist of 3 characters.").refine(uppercaseCheck, "The airport code must be 3 uppercase characters."),
