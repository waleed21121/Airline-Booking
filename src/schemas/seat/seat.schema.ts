...
export const SeatSchema = z.object({
    ...
    type: z.enum(['businuss', 'economy', 'premium-economy', 'first-class'], {message: "The type of seat must be one of the following values: businuss, economy, premium-economy, first-class"}).default("economy").optional()
});
